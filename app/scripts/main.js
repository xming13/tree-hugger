...
function renderAnim() {
    ...
    transitionTimeline7
        ...
        .to(fishContainer, 8.8, {x: LEFT_4, startAt: {x: LEFT_0, scaleX: -1}, ease: Power0.easeNone}, 'transition7b')
    ...
    transitionTimeline8
        ...
        .to(cactusContainer2, .5, {y: TOP_2, ease: Power0.easeNone}, 'transition8')
        .add('overlay')
        .add(function () {
